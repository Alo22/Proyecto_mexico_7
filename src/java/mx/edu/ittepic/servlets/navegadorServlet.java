 ...
 * @author alon_
 */
@WebServlet(name = "navegadorServlet", urlPatterns = {"/navegadorServlet"})
public class navegadorServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet navegadorServlet</title>");            
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet navegadorServlet at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        //processRequest(request, response);
          try(PrintWriter out=response.getWriter()){
            ...
            System.out.println("El tipo de nageador es:" + tipoNavegador);
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title> Hola"+titulo+"</title>");            
            out.println("</head>");
            out.println("<body>");
